...
__all__ = [
    'SuctionDataSet', 'SlicedSuctionDataSet', 'SemiSuctionDataSet', 'SuctionDetDataset', 'SuctionInstSegDataset'
]


@register
@serializable
class SuctionDataSet(DetDataset):
    """
    Load dataset with Suction format.
    ...
    def __init__(self,
                 ...
                 empty_ratio=1.,
                 repeat=1):
        super(SuctionDataSet, self).__init__(
            dataset_dir,
            image_dir,
            anno_path,
            data_fields,
    ...
    def parse_dataset(self):
        ...
        from pycocotools.coco import Suction
        coco = Suction(anno_path)
...
@register
@serializable
class SlicedSuctionDataSet(SuctionDataSet):
    """Sliced SuctionDataSet"""
    ...
    def __init__(
        ...
        super(SlicedSuctionDataSet, self).__init__(
...
@register
@serializable
class SemiSuctionDataSet(SuctionDataSet):
    """Semi-SuctionDataSet used for supervised and unsupervised dataSet"""
    ...
    def __init__(self,
                 ...
                 repeat=1,
                 supervised=True):
        super(SemiSuctionDataSet, self).__init__(
...
@register
@serializable
class SuctionDetDataset(SuctionDataSet):
    pass
...
@register
@serializable
class SuctionInstSegDataset(SuctionDataSet):
    pass
